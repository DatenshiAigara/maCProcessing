...
CP_Color CP_Color_Lerp(CP_Color a, CP_Color b, float lerp_factor)
{
...
/*CP_Color CP_Color_FromColorHSL(CP_ColorHSL hsl)
{
    ...
    NVGColor c1 = (hsl.h / 360.0f, hsl.s / 100.0f, hsl.l / 100.0f, (unsigned char)hsl.a);
    CP_Color c = {
...
CP_ColorHSL CP_ColorHSL_Create(int h, int s, int l, int a)
{
 ...
 CP_ColorHSL CP_ColorHSL_Lerp(CP_ColorHSL a, CP_ColorHSL b, float lerp_factor)
{
	lerp_factor = CP_Math_ClampFloat(lerp_factor, 0, 1.0f);
	CP_ColorHSL result = {
